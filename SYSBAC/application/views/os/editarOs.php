                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span6" style="margin-left: 0">
                                             <label for="folio">Folio<span >*</span></label>
                                            <input id="folio" class="span12" type="text" name="folio" value="<?php echo $result->folio ?>"  />
...
<div id="modalProducto" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="myModalLabel">SYSBAC O.S - Agregar Nuevo Producto</h3>
  </div>
  <div class="modal-body">
    <div class="widget-content nopadding">
...
<!-- Modal Servicio-->
  ...
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="myModalLabel">SYSBAC O.S - Agregar Nuevo Servicio</h3>
    </div>
  <div class="modal-body">
    <div class="widget-content nopadding">
                <?php echo $custom_error; ?>
